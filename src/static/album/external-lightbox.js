...
shareButton.className='external-share';
shareButton.setAttribute('aria-label','Abrir en el proveedor');
shareButton.title='Abrir en el proveedor';
shareButton.textContent='↗';
Object.assign(shareButton.style,{position:'absolute',zIndex:'1',top:'10px',right:'58px',minHeight:'36px',padding:'6px 10px',background:'rgba(23,19,29,.78)',color:'#fff'});
...
shareButton.onclick=()=>{if(sourceUrl.startsWith('https://'))window.open(sourceUrl,'_blank','noopener')};
